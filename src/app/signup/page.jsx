  ...
  return (
    <div className="bg-[#e9ecef] min-h-screen flex items-center justify-center py-4">
      ...
      >
        ...
        {error && <p className="mb-3 text-center text-red-500" aria-live="assertive">{error}</p>}
        {success && <p className="mb-3 text-center text-green-500" aria-live="assertive">{success}</p>}
        ...
        <div className="mb-5">
          ...
          <input
            ...
            required
            aria-describedby="nameHelperText"
          />
        </div>
        <div className="mb-5">
          <label
        ...
        <div className="mb-5">
          ...
          <input
            ...
            placeholder="**********"
            required
            aria-describedby="rePasswordHelperText"
          />
        </div>
        <button
          type="submit"
